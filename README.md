...
| [cloudprobe/dotfiles](https://github.com/cloudprobe/dotfiles) | Zero-to-productive dotfiles for engineers — one-click install            | Zsh, zinit, Starship, Claude Code (hierarchical config), AWS, Kubernetes, Terraform, macOS                                                       |
